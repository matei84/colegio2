            ...
            <div class="container" style="border: 2px solid black; margin-top: 50px;">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="nombreAlumno" aria-describedby="" required>
                        </div>
                        <div class="col">
                            <label for="apellidoAlumno" class="form-label">Apellido del Alumno</label>
                            <input type="text" class="form-control" id="apellidoAlumno" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="identificadorAlumno" class="form-label">Identificador del Alumno</label>
                            <input type="text" class="form-control" id="identificadorAlumno" required>
                        </div>
                        
                        <div class="col">
                            <label for="telefAlumno" class="form-label">Telefono del Alumno</label>
                            <input type="text" class="form-control" id="telefAlumno" required>
                        </div>
                    </div>
