...
<html lang="en">
    ...
    <body style="background-color: black">
        ...
        <div style="margin-top:5px">
            <table class="table table-bordered border-black" id="invoiceTable">
                ...
                <!-- Tabla modificable con nuevos productos -->
        ...
        <div style="margin-left:300px">
            <h3>Sub-Total:</h3><h3 id="subtotal"></h3> 
            <h3>IVA:<h3 id="iva"></h3></h3>
